<template>
  <div id="app">
    ...
    <head-nav></head-nav>
    <div class="main" v-if="this.$route.path != '/about'">
      <div class="content"><router-view /></div>

      <div class="sideNav">
        <latest-articles :latests="latest"></latest-articles>
        <list :kinds="classes"></list>
        <tags :items="tags"></tags>
      </div>
    </div>
    <div class="aboutBox" v-if="this.$route.path === '/about'">
      <router-view />
    </div>
  </div>
</template>
